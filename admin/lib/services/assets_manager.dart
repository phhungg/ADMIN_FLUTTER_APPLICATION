...
// general images
  ...
  static String admin = "$imagesPath/user-setting.png";
  static String error = "$imagesPath/error.png";
  static String emptySearch = "$imagesPath/empty_search.png";
  static String shoppingCart = "$imagesPath/store.png";
  ...
  static String order = "$dashboardImagesPath/cargo.png";
  static String cloud = "$dashboardImagesPath/server.png";
}
